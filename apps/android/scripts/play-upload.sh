...
UPLOAD="${UPLOAD:-1}"
TRACK="${SHITTER_PLAY_TRACK:-${SHITTER_PLAY_TRACK:-internal}}"
PLAY_SERVICE_ACCOUNT_JSON="${SHITTER_PLAY_SERVICE_ACCOUNT_JSON:-${SHITTER_PLAY_SERVICE_ACCOUNT_JSON:-}}"
UPLOAD_STORE_FILE="${SHITTER_UPLOAD_STORE_FILE:-${SHITTER_UPLOAD_STORE_FILE:-}}"
UPLOAD_STORE_PASSWORD="${SHITTER_UPLOAD_STORE_PASSWORD:-${SHITTER_UPLOAD_STORE_PASSWORD:-}}"
UPLOAD_KEY_ALIAS="${SHITTER_UPLOAD_KEY_ALIAS:-${SHITTER_UPLOAD_KEY_ALIAS:-}}"
UPLOAD_KEY_PASSWORD="${SHITTER_UPLOAD_KEY_PASSWORD:-${SHITTER_UPLOAD_KEY_PASSWORD:-}}"
